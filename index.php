...
<html lang="en">
  <head>
    ...
    <script defer src="js/scrpt.js"></script>
    <title>iRailway-Home</title>
  </head>
  <body>
    <header>
    ...
    <main>
      <div class="slideshow-container">
        <div class="mySlides fade">
          ...
          <img src="image/1.jpg" height="500px" style="width: 100%" />
        </div>

        <div class="mySlides fade">
          <!-- <div class="numbertext">2 / 3</div> -->
          <img src="image/2.jpg" height="500px" style="width: 100%" />
        </div>

        <div class="mySlides fade">
          <!-- <div class="numbertext">3 / 3</div> -->
          <img src="image/3.jpg" height="500px" style="width: 100%" />
        </div>
      </div>
      <br />
    ...
    <section class="section-home">
      ...
      <section class="section-details">
        ...
        <p>
          ...
          more efficient than other forms of transport. <br />
      ...
      <section class="section-details">
        <p>
          ...
          systems during this time as well. <br />
      ...
      <section class="section-details">
        ...
        <p>
          ...
          every continent besides uninhabited Antarctica.[10] <br />
